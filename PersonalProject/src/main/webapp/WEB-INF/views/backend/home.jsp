...
<link rel="shortcut icon"
	href="${classpath }/backend/${classpath }/backend/assets/images/favicon.png" />
</head>
	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<form action="${classpath }/admin/home" method="get">
							...
							<div class="col-xl-3 col-sm-6 grid-margin stretch-card">
								<div class="card">
									<div class="card-body">
										...
										<h6 class="text-muted font-weight-normal">Potential
											growth</h6>
									</div>
								</div>
							</div>
										...
										<div class="row">
											<div class="col-8 col-sm-12 col-xl-8 my-auto">
												<div class="d-flex d-sm-block d-md-flex align-items-center">
													...
													<p class="text-danger ms-2 mb-0 font-weight-medium">-2.1%
													</p>
												</div>
											...
											<table class="table">
												...
												<tbody>
													<tr>
														...
														<td><img
															src="${classpath }/backend/assets/images/faces/face1.jpg"
															alt="image" /> <span class="ps-2">Henry Klein</span></td>
														<td>02312</td>
														<td>$14,500</td>
														<td>Dashboard</td>
														<td>Credit card</td>
													...
													<tr>
														...
														<td><img
															src="${classpath }/backend/assets/images/faces/face2.jpg"
															alt="image" /> <span class="ps-2">Estella Bryan</span></td>
														<td>02312</td>
														<td>$14,500</td>
														<td>Website</td>
													...
													<tr>
														...
														<td><img
															src="${classpath }/backend/assets/images/faces/face5.jpg"
															alt="image" /> <span class="ps-2">Lucy Abbott</span></td>
														<td>02312</td>
														<td>$14,500</td>
														<td>App design</td>
														<td>Credit card</td>
													...
													<tr>
														...
														<td><img
															src="${classpath }/backend/assets/images/faces/face3.jpg"
															alt="image" /> <span class="ps-2">Peter Gill</span></td>
														<td>02312</td>
														<td>$14,500</td>
														<td>Development</td>
													...
													<tr>
														...
														<td><img
															src="${classpath }/backend/assets/images/faces/face4.jpg"
															alt="image" /> <span class="ps-2">Sallie Reyes</span></td>
														<td>02312</td>
														<td>$14,500</td>
														<td>Website</td>
														<td>Credit card</td>
									...
									<div class="card-body">
										...
										<div class="preview-list">
											<div class="preview-item border-bottom">
												<div class="preview-thumbnail">
													<img
														src="${classpath }/backend/assets/images/faces/face6.jpg"
											...
											<div class="preview-item border-bottom">
												<div class="preview-thumbnail">
													<img
														src="${classpath }/backend/assets/images/faces/face8.jpg"
														alt="image" class="rounded-circle" />
												</div>
												<div class="preview-item-content d-flex flex-grow">
													<div class="flex-grow">
											...
											<div class="preview-item border-bottom">
												<div class="preview-thumbnail">
													<img
														src="${classpath }/backend/assets/images/faces/face9.jpg"
														alt="image" class="rounded-circle" />
												</div>
												<div class="preview-item-content d-flex flex-grow">
													<div class="flex-grow">
											...
											<div class="preview-item border-bottom">
												<div class="preview-thumbnail">
													<img
														src="${classpath }/backend/assets/images/faces/face11.jpg"
														alt="image" class="rounded-circle" />
												</div>
												<div class="preview-item-content d-flex flex-grow">
													<div class="flex-grow">
								...
								<div class="card">
									<div class="card-body">
										...
										<div
											...
											<div class="item">
												<img
													src="${classpath }/backend/assets/images/dashboard/Rectangle.jpg"
													alt="">
											</div>
											<div class="item">
												<img
													src="${classpath }/backend/assets/images/dashboard/Img_5.jpg"
													alt="">
											</div>
											<div class="item">
												<img
													src="${classpath }/backend/assets/images/dashboard/img_6.jpg"
													alt="">
											</div>
										</div>
										<div class="d-flex py-4">
											<div class="preview-list w-100">
												<div class="preview-item p-0">
													<div class="preview-thumbnail">
														<img
															src="${classpath }/backend/assets/images/faces/face12.jpg"
