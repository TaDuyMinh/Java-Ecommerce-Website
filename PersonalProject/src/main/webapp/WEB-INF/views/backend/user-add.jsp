											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													<label for="role">User role</label> <select
														class="form-control text-white" id="role" name="role">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:input path="username" type="text"
														class="form-control text-white text-white" id="username"
														name="username" placeholder="user name"></sf:input>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:input path="password" type="passward"
														class="form-control text-white" id="password"
														name="password" placeholder="password"></sf:input>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:input path="name" type="text"
														class="form-control text-white" id="name" name="name"
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:input path="mobile" type="text"
														class="form-control text-white" id="mobile" name="mobile"
														placeholder="mobile"></sf:input>
												</div>
											</div>
										</div>
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:input path="email" type="text"
														class="form-control text-white" id="email" name="email"
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:input path="address" type="text"
														class="form-control text-white" id="address"
														name="address" placeholder="address"></sf:input>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:select path="userCreateUser.id"
														class="form-control text-white" id="userCreateUser">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
													...
													<sf:select path="userUpdateUser.id"
														class="form-control text-white" id="userUpdateUser">
														<sf:options items="${users }" itemValue="id"
															itemLabel="username"></sf:options>
													</sf:select>
												</div>
											...
											<div class="col-md-12">
												<div class="form-group mb-4">
													...
													<sf:textarea path="description" id="description"
														name="description" class="form-control text-white"
														rows="3" placeholder="desription..."></sf:textarea>
												</div>
											</div>
										</div>
