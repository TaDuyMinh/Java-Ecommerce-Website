		...
		<ul class="navbar-nav navbar-nav-right">
			...
			<li class="nav-item dropdown border-left"><a
				...
				<div
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<img src="${classpath }/backend/assets/images/faces/face4.jpg"
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<img src="${classpath }/backend/assets/images/faces/face2.jpg"
								alt="image" class="rounded-circle profile-pic">
						</div>
						<div class="preview-item-content">
					...
					<a class="dropdown-item preview-item">
						<div class="preview-thumbnail">
							<img src="${classpath }/backend/assets/images/faces/face3.jpg"
								alt="image" class="rounded-circle profile-pic">
						</div>
						<div class="preview-item-content">
			...
			<li class="nav-item dropdown"><a class="nav-link"
				...
				<div
					...
					<div class="dropdown-divider"></div>
					<a class="dropdown-item preview-item " href="${classpath }/logout">
