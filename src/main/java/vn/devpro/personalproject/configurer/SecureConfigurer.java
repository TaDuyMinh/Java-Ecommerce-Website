...
import vn.devpro.personalproject.service.UserDetailServiceImpl;
...
//				.defaultSuccessUrl("/admin/home", true) // login thanh cong thi vao trang home
				// (backend) step 1+2
				.successHandler(new UrlAuthenticationSuccessHandler()) // Login thanh cong: Chuyen den request phu hop
																		// voi role step 3
